...
public class RobotokTippelnekGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtAreaHarom = new javax.swing.JTextArea();
        ...
        cbMogeFuz = new javax.swing.JCheckBox();
        jPanel1 = new javax.swing.JPanel();
        jLabel1 = new javax.swing.JLabel();
        txtVelSzam1 = new javax.swing.JTextField();
        cbKulon = new javax.swing.JCheckBox();
        ...
        txtAreaHarom.setColumns(20);
        txtAreaHarom.setRows(5);
        txtAreaHarom.setText("A kitalálandó szám: 10\n1. robot tippje: 10\n2. robot tippje: 4\n3. robot tippje: 2\nAz 1. robot eltalálta!\n\nA kitalálandó szám: 10\n1. robot tippje: 3\n2. robot tippje: 10\n3. robot tippje: 10\nA 2. robot eltalálta!\nA 3. robot eltalálta!");
        jScrollPane1.setViewportView(txtAreaHarom);
        ...
        cbMogeFuz.setSelected(true);
        cbMogeFuz.setText("Mögé fűz");
        ...
        cbKulon.setSelected(true);
        cbKulon.setText("Különböző számok");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        jRadioButton3.setSelected(true);
        txtAreaHarom.setText("");
        jTextArea2.setText("");
        cbMogeFuz.setSelected(true);
    }//GEN-LAST:event_jMenuItem2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        boolean mindentMutat = cbKulon.isSelected();
        Random rnd = new Random();
        int minValue = (int) numMin.getValue();
        int maxValue = (int) numMax.getValue();
        int kitalalando = Integer.parseInt(txtVelSzam1.getText());
        
        int egyTipp = rnd.nextInt(maxValue - minValue + 1) + minValue;
        int kettoTipp = rnd.nextInt(maxValue - minValue + 1) + minValue;
        int haromTipp = rnd.nextInt(maxValue - minValue + 1) + minValue;
        
        if(mindentMutat) {
            txtAreaHarom.setText("A kitalálandó szam: " + kitalalando + "\n"
            + "1. robot tippje: " + egyTipp + "\n"
            + "2. robot tippje: " + kettoTipp + "\n"
            + "3. robot tippje: " + haromTipp + "\n");
        }
    ...
    private javax.swing.JCheckBox cbKulon;
    private javax.swing.JCheckBox cbMogeFuz;
    ...
    private javax.swing.JTextArea txtAreaHarom;
